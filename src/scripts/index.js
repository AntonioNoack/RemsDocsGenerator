...
function displayClass(dataK, path, subPath, key) {
	...
	let prefix = ["src", "test/src", "KOML/src", "SDF/src", "Bullet/src", "BulletJME/src", "Box2D/src", "Recast/src", "Lua/src", "PDF/src", "JVM/src", "Mesh/src", "Image/src", "Unpack/src", "Video/src"][dataK.p]
